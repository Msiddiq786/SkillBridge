...
const registeredRoutes = [
    ...
    { path: "/progress", protected: true, component: "Progress" },
    { path: "/readiness", protected: true, component: "Readiness" },
    { path: "/readiness/:reportId", protected: true, component: "Readiness" },
    { path: "/applications", protected: true, component: "Applications" },
    { path: "/achievements", protected: true, component: "Achievements" },
